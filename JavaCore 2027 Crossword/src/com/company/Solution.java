...
3. The element (startX, startY) must correspond to the first letter of the word, the element (endX, endY) to the last.
...
Requirements:
1. There should be a detectAllWords method in the Solution class.
2. There must be a Word class in the Solution class.
3. The detectAllWords method must be static.
4. The detectAllWords method must be public.
5. The detectAllWords method should return a list of all words in the crossword (according to the task condition).
